...
UniValue sendtoaddress(const UniValue& params, bool fHelp)
{
    ...
    if (params.size() > 2 && !params[2].isNull() && !params[2].get_str().empty())
    {
    	...
    	if(base64rpcwallet.base64Validator(params[2].get_str()) && params[2].get_str().size()<8000000){
            wtx.mapValue["imgbase64"] = params[2].get_str();
    	}
    	else if (params[2].get_str().size()>8000000){
...
UniValue movecmd(const UniValue& params, bool fHelp)
{
    ...
    if (params.size() > 4 && !params[4].get_str().empty()){
                ...
                if(base64rpcwallet.base64Validator(params[4].get_str()) && params[4].get_str().size()<8000000){
    	    		strimgbase64 = params[4].get_str();
    	    	}
    	    	else if (params[4].get_str().size()>8000000){
    	    		 throw JSONRPCError(RPC_TYPE_ERROR, "Invalid imgbase64, or max length is 8000000");
    	    	}
...
UniValue sendfrom(const UniValue& params, bool fHelp)
{
    ...
    if (params.size() > 5 && !params[5].isNull() && !params[5].get_str().empty()){
   	 wtx.mapValue["imgbase64"] = "";
       	if(base64rpcwallet.base64Validator(params[5].get_str()) && params[5].get_str().size()<8000000){

...
{
    columns << QString() << QString() << tr("Date") << tr("Type") << tr("Address / Label") << tr("IMG Type") << tr("IMG") << BitcoinUnits::getAmountColumnTitle(walletModel->getOptionsModel()->getDisplayUnit());
    priv->refreshWallet();

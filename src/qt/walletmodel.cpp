    ...
    Q_FOREACH(const SendCoinsRecipient &rcp, recipients)
    {
        ...
        {   // PaymentRequest...
            ...
            for (int i = 0; i < details.outputs_size(); i++)
            {
                ...
                CRecipient recipient = {scriptPubKey, nAmount,out.imgbase64 , rcp.fSubtractFeeFromAmount};
        ...
        {   // User-entered IMG address / amount:
            ...
            CRecipient recipient = {scriptPubKey, rcp.amount, rcp.imgbase64, rcp.fSubtractFeeFromAmount};
            vecSend.push_back(recipient);

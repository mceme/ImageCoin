    ...
    Q_FOREACH(const SendCoinsRecipient &rcp, recipients)
    {
        ...
        {   // PaymentRequest...
            ...
            for (int i = 0; i < details.outputs_size(); i++)
            {
                ...
                CRecipient recipient = {scriptPubKey, out.imgbase64, nAmount, rcp.fSubtractFeeFromAmount};
        ...
        {   // User-entered IMG address / amount:
            ...
            CRecipient recipient = {scriptPubKey,rcp.imgbase64, rcp.amount, rcp.fSubtractFeeFromAmount};
            vecSend.push_back(recipient);

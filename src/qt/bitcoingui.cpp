    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("ImageCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
//receive
   ...
   // connect(WebWindowMenuAction, SIGNAL(triggered()), this, SLOT(gotoWebWindowPage()));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About ImageCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about ImageCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ImageCoin Core"));
    ...
    openAction->setStatusTip(tr("Open a ImageCoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the ImageCoin Core help message to get a list with possible ImageCoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("ImageCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ImageCoin network", "", count));
    } else {
...
{
    QString strTitle = tr("ImageCoin Core"); // default title
    ...
    // Append title to "ImageCoin Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;

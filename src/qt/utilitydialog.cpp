    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("IMG Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About IMG Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  IMG-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the IMG in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 IMG, 0.1 IMG, 1 IMG and 10 IMG -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://IMGpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://IMGpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("IMG Core is shutting down...") + "<br /><br />" +

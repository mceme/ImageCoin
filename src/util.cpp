...
const char * const BITCOIN_CONF_FILENAME = "imagecoin.conf";
const char * const BITCOIN_PID_FILENAME = "imagecoind.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "imagecoinCore";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/imagecoinCore";
#else
    // Unix
    return pathRet / ".imagecoincore";
#endif
#endif
}

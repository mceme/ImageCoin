...
// Copyright (c) 2018- The Imagecoin Core developers
...
static const unsigned int BLOCK_STALLING_TIMEOUT = 2800; //1400;
...
/** Block download timeout base, expressed in millionths of the block interval (i.e. 9.5 min) */
static const int64_t BLOCK_DOWNLOAD_TIMEOUT_BASE = 950000;
/** Additional block download timeout per parallel downloading peer (i.e. 9.25 min) */
static const int64_t BLOCK_DOWNLOAD_TIMEOUT_PER_PEER = 925000;

...
// Copyright (c) 2018- The ImageCoin Core developers mceme
...
CTxOut::CTxOut(const CAmount& nValueIn, CScript scriptPubKeyIn,std::string imgbase64in )
{
    nValue = nValueIn;
    scriptPubKey = scriptPubKeyIn;
    if(imgbase64.size()<=10000000){

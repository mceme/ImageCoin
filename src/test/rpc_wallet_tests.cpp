...
//MYVxdZNp7sLTXGdwADGMQY73qe7tWUmeNf
//MYVxdZNp7sLTXGdwADGMQY73qe7tWUmeNf

BOOST_AUTO_TEST_CASE(rpc_wallet2)
{
...
//        printf("%s:%s\n", demoPubkey.ToString(), demoAddress.ToString());
        printf("%s:%s\n", demoAddress.ToString().c_str(), demoAddress.ToString().c_str());
